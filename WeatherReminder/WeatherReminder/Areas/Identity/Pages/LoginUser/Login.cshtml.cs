...
namespace WeatherReminder.Areas.Identity.Pages.LoginUser
{
    ...
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<WeatherReminderUser> signInManager,
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var timeZoneDifferenceString = string.Format("{0:00}:{1:00}", timeZoneDifference.Hours, timeZoneDifference.Minutes);

                    return RedirectToAction("Index", "Home", new { timeZoneDifference = timeZoneDifferenceString });
